...
from med.views import AboutView, Add_to_cartView, Add_to_wishlist, AddressDeleteView, AllproductView, CartView, CheckoutView, ContactView, DeleteView, IndexView, ListDeleteView, LoginView, OrderView, ProductInfoView, ProfileView, ShopView, SignupView,SigninView,LogoutView,ChangePassView, UpdateaddressView, WishListView, clearcart, minus_quantity, pluse_quantity, CustomerAddressView
