    ...
    <body>
        ...
        <div id="site-content">
            ...
            <main class="main-content">
                <div class="page">
                    <div class="container">
                        <h2 class="section-title" style="text-align:center;" id="Report_Heading">List of Customers</h2>
                        <div class="row">
                            <div id="stable">
                                ...
                                <%
                                    try {
                                        ...
                                        ResultSet rs = st.executeQuery("select * from hair_studio.customer_reg order by customer_id");

                                        while (rs.next()) {
                                            out.println("<div class='price-list'>");
                                            out.println("<ul class='prices'>");
                                            out.println("<li class='row mt-10 text-center'>");
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("f_name") +"  "+ rs.getString("l_name") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("city") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("mobile") + "</div>");
