    ...
    <body>
        ...
        <div id="site-content">
            ...
            <main class="main-content">
                <div class="page">
                    <div class="container">
                        <h2 class="section-title" style="text-align:center;" id="Report_Heading">Confirmed Appointment</h2>
                        <div class="row">
                            <div id="stable">
                                ...
                                <%
                                    try {
                                        ...
                                        ResultSet rs = st.executeQuery("select * from hair_studio.appointment where status='Confirmed'");
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<div class='col-md-4' style='display: inline;'>" + rs.getString("app_date") + "</div>");
