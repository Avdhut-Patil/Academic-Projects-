    ...
    <body>
        ...
        <div id="site-content">
            ...
            <main class="main-content">
                <div class="page">
                    <div class="container">
                        <h2 class="section-title" style="text-align:center;" id="Report_Heading">List of Services</h2>
                        <div class="row">
                            <div id="stable">
                                <div class="price-list" >
                                    <ul class="prices">
                                        <li class="row mt-10 text-center">
                                            ...
                                            <div class="col-md-3 " style="display: inline;" id="removelink">
                                                Action
                                            </div>
                                        </li>                                                                                
                                    </ul>
                                ...
                                <%
                                    try {
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("service_category") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("service_name") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("price") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;' id='removelink'>");
                                %>

                                <a class="genric-btn circle info small" href="admin_edit_service.jsp?sid=<%=sid%>"><span ><i class="fa fa-edit"></i></span>&nbsp;Edit</a>
                                &nbsp;&nbsp;
                                <a class="genric-btn circle danger small" onclick="return askandredirect('admin_remove_service.jsp?sid=<%=sid%>');"><span ><i class="fa fa-trash"></i></span>&nbsp;Remove</a>
