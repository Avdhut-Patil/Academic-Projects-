    ...
    <body>
        ...
        <div id="site-content">
            ...
            <main class="main-content">
                <div class="page">
                    <div class="container">
                        <h2 class="section-title" style="text-align:center;" id="Report_Heading">Pending Appointments</h2>
                        <div class="row">
                            <div id="stable">
                                ...
                                <%
                                    try {
                                        ...
                                        ResultSet rs = st.executeQuery("select * from hair_studio.appointment where status='Pending'");
                                        ...
                                        while (rs.next()) {
                                            ...
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("email") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("service_name") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;'>" + rs.getString("app_date") + "</div>");
                                            out.println("<div class='col-md-3' style='display: inline;' id='removelink'>");
                                %>
                                <a class="genric-btn circle danger small" onclick="return askandredirect('confirm_appointment_act.jsp?aid=<%=aid%>');"><span ><i class="fa fa-thumbs-up"></i></span>&nbsp;Confirm</a>
                                <% out.println("</div>");
                                            out.println("</li>");
                                            out.println("</ul>");
                                            out.println("</div>");
